...
- **Zoom:** mouse wheel, anchored at the cursor (zoom factor preserved at cursor point). Zoom-in is allowed up to 3200% (level-0 tiles are upscaled; no finer detail is generated past 1:1); zoom-out is unbounded (tiles render at their coarsest level and stop enlarging).
- **Pan:** Ctrl+drag.
